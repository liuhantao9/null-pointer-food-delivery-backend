...
public class MongoDBService implements Service {
    ...
    static String getDatabaseURI() {
        ...
        return "mongodb://root:123@cluster0-shard-00-00.znlku.mongodb.net:27017,cluster0-shard-00-01.znlku.mongodb.net:27017,cluster0-shard-00-02.znlku.mongodb.net:27017/FoodDelivery?ssl=true&replicaSet=atlas-a6l8fm-shard-0&authSource=admin&retryWrites=true&w=majority"; // connect to localhost by default
    }
